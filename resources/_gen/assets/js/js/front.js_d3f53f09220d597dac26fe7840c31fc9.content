...
counters()
contactFormAjax()})
function contactFormAjax(){var form=$('.contact-form-ajax')
...
return false})}
function sliderHomepage(){if($('#slider').length){$('#slider').owlCarousel({autoPlay:3000,items:2,itemsDesktopSmall:[900,3],itemsTablet:[600,3],itemsMobile:[500,2]})}}
function sliders(){if($('.owl-carousel').length){$('.customers').owlCarousel({items:2,itemsDesktopSmall:[990,2],itemsTablet:[768,2],itemsMobile:[480,1]})
$('.testimonials').owlCarousel({items:2,itemsDesktopSmall:[990,3],itemsTablet:[768,2],itemsMobile:[480,1]})
